...
let pointRadius = 10;
let colors = ["#0ea836", "#fdb707", "#ff6709", "#e84c89", "#50197d", "#2196f3", "#03a9f4", "#00bcd4", "#009688", "#4caf50", "#8bc34a", "#cddc39", "#ffeb3b", "#ffc107", "#ff9800", "#ff5722"];
...
document.getElementById("play-button").addEventListener("click", function () {runAlgorithm()});
